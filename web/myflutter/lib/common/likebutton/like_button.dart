...
class _LikeButtonState extends State<LikeButton> with TickerProviderStateMixin {
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Transform.scale(
            scale: is_first ? 1.0 : (widget.is_trues ? scale.value : 1.0),
            child: GestureDetector(
              child: Icon(
                widget.icon.icon,
                color: widget.is_trues ? widget.icon.color : Colors.grey,
  ...
  void _onTap() {
    ...
    setState(() {
      is_first = false;
      widget.is_trues = !widget.is_trues;
    });
    ...
    if (widget.onIconClicked != null) widget.onIconClicked(widget.is_trues);
  }
