...
//    data[HTTP_REQUEST_TYPE] ?: return NoSetRequestType().put("message", "缺少请求参数 _type，请检查")
//
//    try {
//        HttpRequestType.valueOf((data[HTTP_REQUEST_TYPE] as String).toUpperCase())
//    } catch (e: Exception) {
//        log.error("缺失请求参数：" + data[HTTP_REQUEST_TYPE], e)
//        return writeCorrectParaResult(
//            thisResult,
//            "\"message\":\"缺失请求参数 ${data[HTTP_REQUEST_TYPE]} 或找不到对应的值。 \""
//        )
//    }
