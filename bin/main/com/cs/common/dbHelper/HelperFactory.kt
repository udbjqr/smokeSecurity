...
import com.cs.common.util.FileUtil
...
object JDBCHelperFactory {
	...
	init {
		...
		config = JSON.parseObject(FileUtil.getProperties(Loader.getResource("db.json", JDBCHelperFactory::class.java.classLoader), "UTF-8"))
